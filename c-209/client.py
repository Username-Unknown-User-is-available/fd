...
def openChatWindow():
    ...
    attachAndSend=Button(window, text="Atach and Send", bd=1, font=("Calibri", 10))
    attachAndSend.place(x=10, y=305)
    ...
    filePathLable = Label(window, text="", fg="blue", font=("Calibri", 8))
